...
OCR Scan — Extracts text using Tesseract OCR
Keyword Search — Looks for "expiry", "valid till", "exp date" near dates
Pattern Match — Finds DD/MM/YYYY, DD-MMM-YYYY, ISO dates
Scoring — Scores candidates by keyword proximity + future dates preferred
Heuristic Fallback — Suggests typical validity per document type
